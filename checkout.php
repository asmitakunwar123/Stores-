...
if(isset($_POST['order'])){
   ...
   $address = 'flat no. ' .'  '. $_POST['city'] .' '. $_POST['country'] .' - '. $_POST['pin_code'];
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <select name="method" class="box" required>
               ...
               <option value="paytm">paytment</option>
               <option value="paypal">paypal</option>
            </select>
         </div>
         <div class="inputBox">
            <span>address  :</span>
            <input type="text" name="address" placeholder="e.g. Address" class="box" required>
         </div>
         
         <div class="inputBox">
            <span>city :</span>
            <input type="text" name="city" placeholder="e.g. Chitwan" class="box" required>
         </div>
